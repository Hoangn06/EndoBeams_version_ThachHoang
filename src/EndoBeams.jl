module EndoBeams
    ...
    export RigidInteraction, MultiRigidInteraction, SoftInteraction, PlaneSurface, SphereSurface, MovingSphereSurface, CylinderSurface, MovingCylinderSurface, TriangulatedSurface, BeamElementSurface, BeamNodeSurface, DiscreteSignedDistanceField, InteractionProperties
    export Matrices
