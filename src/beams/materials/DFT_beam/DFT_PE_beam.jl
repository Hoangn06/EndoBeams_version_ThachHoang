function compute_DFT_PE_contributions( 
    ...
    # ============================================================
    # Compute the elastic contributions of the inner layer
    # ============================================================
    # Inner layer fully elastic — linear elastic using beam property stiffness (tuple from K̄ⁱⁿᵗ_beam)
    ...
    T̄ⁱⁿᵗū  = T̄ⁱⁿᵗū_outer + T̄ⁱⁿᵗū_inner
