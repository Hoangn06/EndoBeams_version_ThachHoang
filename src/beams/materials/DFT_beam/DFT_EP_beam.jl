function compute_DFT_EP_contributions( 
            K̄ⁱⁿᵗouter, ū, Θ̅₁, Θ̅₂, B¹, B¹¹, B²¹, B¹², B²², B¹⁴, B²⁴, exact, Tₛ⁻¹Θ̅₁, Tₛ⁻¹Θ̅₂,
    ...
    # ============================================================
    # Compute the elastic contributions of the outer layer
    # ============================================================
    # Outer layer fully in Austenite — linear elastic using beam property stiffness (tuple from K̄ⁱⁿᵗ_beam)
    K̄ⁱⁿᵗū_outer, K̄ⁱⁿᵗΘ̅_outer, K̄ⁱⁿᵗΘ̅Θ̅_outer = K̄ⁱⁿᵗouter
