...
K = 10000.0                         # Outer plastic hardening modulus (MPa)
...
# DFT-PE: only outer (plastic) points are stored; inner is elastic (no state)
n_gp_outer = params.nᴳ_beams * (params.nˢ_beams * params.nˢ_beams)

p_stress_strain = plot(
    xlabel="Von-Mises Strain",
    ylabel="Von-Mises Stress (MPa)",
    title="Von-Mises Stress vs. Von-Mises Strain (DFT-PE: Outer plastic + Inner elastic)",
    titlefontsize=30,
    xguidefontsize=28,
    yguidefontsize=28,
    xtickfontsize=24,
...
plot!(p_stress_strain, 
    xlabel="Von-Mises Strain\n──────────────────────────────────────────────────────────── \n Fig.1. Von-Mises stress-strain for DFT-PE beam (outer plastic layer)")
