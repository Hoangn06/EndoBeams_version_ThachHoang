...
sigma_S_AS = 480                  # Start stress for A→S (MPa)
sigma_F_AS = 500                    # Finish stress for A→S (MPa)
sigma_S_SA = 300                    # Start stress for S→A (MPa)
sigma_F_SA = 280                    # Finish stress for S→A (MPa)
sigma_c_SAS = 400                     # Critical stress for SAS transformation (MPa)
Eᴹ = 25000                         # Martensite Young's modulus (MPa)

E_inner = 150000                         # Inner Young's modulus (MPa)
...
radius_inner = 0.01                      # Inner Beam radius (mm)
...
beams = DFT_SEPBeams(nodes, connectivity, E, ν, ρ, εL, sigma_S_AS, sigma_F_AS, sigma_S_SA, sigma_F_SA, sigma_c_SAS, Eᴹ, E_inner, ν_inner, ρ_inner, radius_inner, y0, K, radius, damping)
